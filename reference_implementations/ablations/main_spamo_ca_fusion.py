...
def build_components():
    ...
    fusion = CrossAttentionFusion(
        ...
        landmark_dim  = None,         # no landmarks in this ablation
...
run_name = f"spamo_cross_attention_fusion_{datetime.now().strftime('%Y%m%d_%H%M%S')}.txt"
...
for epoch in range(EPOCHS):
    ...
    ckpt_dir = f"checkpoints/spamo_cafusion_epoch_{epoch}_{timestamp}"
...
for batch in test_loader:
    ...
    fused = fusion(
        ...
        landmark_feats  = None       # no landmarks
    )
